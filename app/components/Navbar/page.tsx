...
export default function Navbar() {
    return (
      ...
      <div>
        ...
        <img src="/png-transparent-kia-logo-kia-motors-kia-spectra-car-kia-cerato-kia-canada-inc-emblem-wikipedia-logo.png" alt="Logo" className="h-full w-full object-cover px-4 py-2 rounded ml-4"/>
        </div>
